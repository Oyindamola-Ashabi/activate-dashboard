...
const products = [
    ...
    { id: 7, img: bigClothFour, title: "Thick Vintage", price: "₦4300", stock: 70, img2: smallImgage, img3: myLove },
    { id: 8, img: bigClothFive, title: "Thick Vintage", price: "₦4300", stock: 60, img2: smallImgage, img3: myLove },
    { id: 9, img: bigClothSix, title: "Thick Vintage", price: "₦4300", stock: 50, img2: smallImgage, img3: myLove }
];
...
const SecondCardTwo = () => {
    ...
    return (
        <div className="cards-wrapper">
            <p className="cards-title">Saved Item</p>
